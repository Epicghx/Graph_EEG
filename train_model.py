...
import argparse
from ast import arg
from MyUtil import random_planetoid_splits, to_sparse_tensor
from models import *
...
def RunExp(args, dataset, data, Net, percls_trn, val_lb, RP):
    ...
    appnp_net = Net(args, dataset)#初始化网络模型，包含数据集特征数、类别数，模型超参
...
if __name__ == '__main__':
    ...
    parser.add_argument('--epsilon', type=float, default=0.3) # FAGCN
